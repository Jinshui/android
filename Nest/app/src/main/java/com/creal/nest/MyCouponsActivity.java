...
public class MyCouponsActivity extends FragmentActivity {
    ...
    public static class CouponListFragment extends PTRListFragment<Coupon> {
        ...
        public PaginationAction<Coupon> getPaginationAction() {
            ...
            parameters.put(Constants.KEY_CARD_ID, PreferenceUtil.getString(getActivity(), Constants.APP_USER_CARD_ID, null));
            return new CommonPaginationAction(getActivity(), 1, 10, Constants.URL_GET_MY_COUPONS, parameters, Coupon.class, "coupons");
        }

        public void showDetailActivity(Coupon coupon) {
            Intent intent = new Intent(getActivity(), CouponDetailActivity.class);
            intent.putExtra(CouponDetailActivity.INTENT_EXTRA_CARD_ID, PreferenceUtil.getString(getActivity(), Constants.APP_USER_CARD_ID, null));
