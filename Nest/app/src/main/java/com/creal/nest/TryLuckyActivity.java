...
public class TryLuckyActivity extends FragmentActivity {
    ...
    public static class CouponListFragment extends PTRListFragment<Coupon> {
        ...
        public PaginationAction<Coupon> getPaginationAction() {
            return new CommonPaginationAction(getActivity(), 1, 10, Constants.URL_GET_LUCKY_COUPONS, null, Coupon.class, "coupons");
        }
                    ...
                    action.execute(new AbstractAction.UICallBack<ReceiveCouponResult>() {
                        public void onSuccess(ReceiveCouponResult result) {
                            if (result.getReceiveId() > 0) {
                                ...
                                Intent intent = new Intent(getActivity(), TryLuckyFailDialogActivity.class);
                                startActivity(intent);
                            }
